      ...
      <div className="space-y-16 flex flex-col items-center  ">
        ...
        {fetchedData.slice(0, 8).map((product:any,index:number) => (
          <div
            ...
            className="hairProduct  landscape:hover:border-x-2 opacity-0 transition duration-200 ease-in
          ...
          >
            ...
            <div className="hairPrize w-[12vw] portrait:w-[26vw]  cursor-pointer font-medium text-green-900 portrait:text-[4vw]">{product.price.toLocaleString('en-NG', { style: 'currency', currency: 'NGN' })}</div>
            </div>
          </div>
        ))}
